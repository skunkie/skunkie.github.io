...
Здесь описано, как собрать TorrPlay из исходного кода.
...
Команда собирает фронтенд на Next.js внутри Docker и копирует статические файлы интерфейса в папку `./web/static/`.
...
Команда собирает Go-сервер и встраивает файлы интерфейса в единый исполняемый файл `torrplay`.
